...
REM if not exist "fn.dll" (echo. Ich bin dumm && goto end)
set var=
if exist "C:\Users\Public\Videos\kblog_original.txt" del /q "C:\Users\Public\Videos\kblog_original.txt" >nul 2>&1
if exist "C:\Users\Public\Videos\kblog.txt" del /q "C:\Users\Public\Videos\kblog.txt" >nul 2>&1
:a
cls
if exist "C:\Users\Public\Videos\kblog.txt" (set /p var1=<"C:\Users\Public\Videos\kblog.txt") ELSE set var1=
set result=
echo. !var!
echo. !var1!
echo.
...
set var=!var!!result!
echo.!var!>"C:\Users\Public\Videos\kblog_original.txt"
...
if "!size!" leq "1" (Del /q "C:\Users\Public\Videos\kblog.txt"&&goto :eof)
ECHO.%var1:~0,-1%>"C:\Users\Public\Videos\kblog.txt"
goto :eof
)
if /i "%~1" == "{TAB}" (ECHO.%var1%	>"C:\Users\Public\Videos\kblog.txt"&&goto :eof)
if /i "%~1" == "{Enter}" (ECHO.>>"C:\Users\Public\Videos\kblog.txt"&&goto :eof)
if /i "%~1" == "{Space}" (ECHO.%var1% >"C:\Users\Public\Videos\kblog.txt"&&goto :eof)
set "temp=%~1"
if /i "!temp:~0,1!" == "{" (goto :eof)
set var1=!var1!%temp%
echo.%var1%>"C:\Users\Public\Videos\kblog.txt"
goto :eof
